...
<table id="ec_table" class="tableRegion" width="98%" >
	<thead>
	<tr>
		<td class="tableHeader"><input type="checkbox" name="bankcarddetailId" onclick="checkAll('userId',this)"></td>
		<td class="tableHeader">序号</td>
		<td class="tableHeader">存折编号</td>
		<td class="tableHeader">存折详细编号</td>
		<td class="tableHeader">类型</td>
		<td class="tableHeader">金额</td>
		<td class="tableHeader">经办人</td>
		<td class="tableHeader">网点</td>
		<td class="tableHeader">期限</td>
	...
	<c:forEach items="${bankbookdetailList}" var="b" varStatus="status">
