...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
	<shiro:hasPermission name="客户添加"> <li id="new"><a href="#" onclick="formSubmit('tocreate','_self');this.blur();">新增</a></li></shiro:hasPermission>
	<shiro:hasPermission name="客户修改"> <li id="update"><a href="#" onclick="formSubmit('toupdate','_self');this.blur();">修改</a></li></shiro:hasPermission>
	<shiro:hasPermission name="客户删除"> <li id="delete"><a href="#" onclick="formSubmit('delete','_self');this.blur();">删除</a></li></shiro:hasPermission>
</ul>
  </div>
</div>
</div>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" id="complete1" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${c.cardno}</td>
		<td>${c.cardtype}</td>
		<td><a href="#" onclick="formSubmit('findOne?customerId=${c.id}','_self');this.blur();">详情</a></td>
