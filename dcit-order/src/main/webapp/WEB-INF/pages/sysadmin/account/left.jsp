...
<div id="sidebar" class="sidebar">
	<div class="sidebar_t">
        ...
        <div class="panel-title">开户管理</div>
        <div class="panel-content">
			<ul>
			<li>
					<a href="${ctx}/account/tocreate" id="aa_1" onclick="linkHighlighted(this)" target="main">开户添加</a>
				</li>					
				<li><a href="${ctx}/account/list" onclick="linkHighlighted(this)" target="main" id="aa_1">开户列表</a></li>
