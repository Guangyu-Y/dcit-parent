...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
	<li id="view"><a href="#" onclick="formSubmit1('transfer','_self');this.blur();">保存</a></li>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd">
		<td>操作类型：</td>
		<td>
		 <span id="type" name="type" value="3">转账</span>
		</td>  
	...
	<tr class="odd">
		<td>对方银行卡：</td>
		<td><input name="eachbankcardno"  type="text" id="eachbankcardno"/><span id="each"></span></td>
		
		<td>对方账户名字</td>
		<td><input name="eachname" type="text" id="eachname"/></td>
