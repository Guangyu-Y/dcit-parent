...
//			alert((0-currLeft) <= maxOffset);
		...
		function toMyModule(moduleName){
			top.leftFrame.location.href = moduleName+'MyLeft.action';
			top.main.location.href = moduleName+'MyMain.action';
			linkHighlightMenu(this);
		}
</script>
...
<div class="PositionFrame_black" id="PositionFrame"></div>
	<div id="userInfo" style="z-index:999;" onclick="HideLoginDiv()" title="点击关闭">
		...
		您好：<strong>${userSession.username}</strong>&nbsp;&nbsp;|
		您所属角色：${roleName }
			<!--  -->
		</strong>&nbsp;&nbsp;
...
<div id="menuContent">
		<span id="topmenu" onclick="toModule('home');">系统首页</span><span id="tm_separator"></span>
			<shiro:hasPermission name="地区管理"> 
			<span id="topmenu" onclick="toMyModule('city');">地区管理</span><span id="tm_separator"></span>
			</shiro:hasPermission>
			
			<shiro:hasPermission name="网点管理"> 
			<span id="topmenu" onclick="toMyModule('website');">网点管理</span><span id="tm_separator"></span>
		     </shiro:hasPermission> 
		     
		     <shiro:hasPermission name="客户管理"> 
			<span id="topmenu" onclick="toMyModule('account');">客户管理</span><span id="tm_separator"></span>
		     </shiro:hasPermission> 
		     
			 <shiro:hasPermission name="银行卡管理"> 
			<span id="topmenu" onclick="toMyModule('bankcard');">银行卡管理</span><span id="tm_separator"></span>
			</shiro:hasPermission> 
			
			 <shiro:hasPermission name="存折管理"> 
			<span id="topmenu" onclick="toMyModule('bankbook');">存折管理</span><span id="tm_separator"></span>
			 </shiro:hasPermission> 
			
			 <shiro:hasPermission name="权限管理"> 
			<span id="topmenu" onclick="toModule('sysadmin');">权限管理</span>
			 </shiro:hasPermission> 
			 <shiro:hasPermission name="贷款管理"> 
			<span id="topmenu" onclick="toMyModule('clloan');">贷款管理</span>
			 </shiro:hasPermission> 
      </div>
